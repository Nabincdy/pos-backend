...
class UpdateLeaveRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'start_date' => ['required', 'date', Rule::unique('leaves', 'id')->withoutTrashed()->ignore($this->leave)],
            'end_date' => ['required', 'date', 'after:start_date', Rule::unique('leaves', 'id')->withoutTrashed()->ignore($this->leave)],
            'reason' => ['nullable'],
            'status' => ['nullable'],
        ];
    }
